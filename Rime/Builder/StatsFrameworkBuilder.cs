...
namespace Rime.Builders
{
    ...
    public class StatsFrameworkBuilder : FrameworkBuilder
    {
        ...
        public void Build(BlockfrostCollection collection, StatsContainer stats)
        {
        ...
        /// <param name="collection"></param>
        /// <param name="stats"></param>
        private void StatsHandlerBlueprint(BlockfrostCollection collection, StatsContainer stats)
        {
            ...
            // Header
            sb.Append($"{OH(1, tabs)}using RimeLibrary.Controller;");
            ...
            sb.Append($"{OH(1, tabs)}");
            sb.Append($"{OH(2, tabs)}namespace RimeLibrary.Builders");
            sb.Append($"{OH(1, tabs)}" + "{");
        ...
        private string Method_Handler(int tabs, BlockfrostCollection collection, StatsContainer stats)
        {
        ...
        private string Method_GenerateCollectionRarity_SQL(int tabs, BlockfrostCollection collection, StatsContainer stats)
        {
            StringBuilder sb = new StringBuilder();
        ...
        // sb.Append($"{OH(1, tabs)}");
        private string Method_RarityChart(int tabs, BlockfrostCollection collection, StatsContainer stats)
        {
            StringBuilder sb = new StringBuilder();
        ...
        /// </summary>
        /// <param name="collection"></param>
        private void Update_StatsBuilder_PopulateAttributeTables(BlockfrostCollection collection)
        {
            {
                StringBuilder sb = new();
        ...
        /// </summary>
        /// <param name="collection"></param>
        protected void RemoveExistingFiles(BlockfrostCollection collection)
        {
        ...
        {
            string fullPath = rimeLibraryDir + $"\\ADO\\Models\\Rarity\\Token\\{path}";
