...
namespace RimeLibrary.Builders
{
    public class RimeFrameworkBuilder : FrameworkBuilder
    {
        ...
        {
            tokenDir = rimeLibraryDir + $"\\ADO\\Models\\Rarity\\Token\\";
        ...
        private void Update_RimeADO(StatsContainer statsContainer)
        {
            ...
            string fileLoc = rimeLibraryDir + "\\ADO\\RimeADO.cs";
        ...
        private void AddRarityToken(StatsContainer statsContainer)
        {
            ...
            sb.Append($"{OH(2, 0)}namespace RimeLibrary.ADO.Rime.Models.Rarity.Token");
            sb.Append($"{OH(1, 0)}" + "{");
        ...
        protected void Remove_Rarity(BlockfrostCollection collection)
        {
            _ducky.Info($"Removing file information for {collection.Name} rarity in the Libary Project...");

            List<string> projectFiles = new(Directory.GetFiles(rimeLibraryDir + "\\ADO", "*.cs", SearchOption.AllDirectories));
        ...
        /// </summary>
        /// <param name="collection"></param>
        private void CreateDirectory(BlockfrostCollection collection)
        {
